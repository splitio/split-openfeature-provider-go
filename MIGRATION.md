...
Version 2.0.0 fixes ObjectEvaluation structure, config parsing, attribute passthrough, and shutdown cleanup. Updates Split Go SDK to v6 and OpenFeature Go SDK to v1.
