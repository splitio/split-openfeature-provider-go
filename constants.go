...
const (
	...
	// Events are sent asynchronously to OpenFeature SDK handlers. A buffer of 100 prevents
	// blocking when handlers are slow, while dropping overflow events (logged as warnings).
