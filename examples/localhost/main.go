...
func main() {
	...
	for _, userID := range testUsers {
		...
		// Object flag with dynamic configuration
		premiumFeatures, _ := ofClient.ObjectValue(ctx, "premium_features", nil, evalCtx)
		appLogger.Info("object flag evaluated", "flag", "premium_features", "value", premiumFeatures)
