...
Rewrite with updated SDK support, lifecycle management changes, and bug fixes.
...
- **`Config.APIKey` renamed to `Config.SDKKey`** to match Split SDK terminology
